...
<table width="100%">
    <tr>
        <td align="left" width="100%" colspan="2">
            <strong>Shades-of-Purple Theme for Slack</strong><br />
...
> Professional Slack color-scheme with hand-picked & bold shades of purple 💜 to go along with your Slack group. A custom Slack color-scheme.
...
2. Scroll to the bottom and paste these colors: `#2D2B55,#6943FF,#FAD000,#1E1E3F,#6943ff,#cec5ff,#3ad900,#6943ff`
7. Done!!! 🙌
